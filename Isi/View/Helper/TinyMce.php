 ...
 *
 */
class Isi_View_Helper_TinyMce extends Zend_View_Helper_Abstract
{
    ...
    public function __set($name, $value)
    {
        ...
        if (!method_exists($this, $method)) {
            throw new Isi_View_Exception('Invalid tinyMce property');
        }
        $this->$method($value);
    }
    ...
    public function setLanguage() {
        $language = Zend_Registry::get('personalization')->getLanguage();
